    ...
    <main className="relative">
        ...
        <div className="flex gap-8 items-center">
          ...
          <div className="w-1/2">
            ...
            <p className=" text-gray-700">
              Somos una empresa 100% mexicana, que nace de una familia dedicada
              a la construcción. Iniciamos vendiendo lámparas básicas en
              autoservicios y abarrotes; sin embargo, hoy somos reconocidos como
              especialistas en iluminación, tanto de interiores como de
              exteriores, con productos certificados que enfatizan en su diseño
              y durabilidad.
            </p>
            <p>
              ...
              Adicionalmente, ¡estamos comprometidos con nuestro planeta!
              Cuidamos que cada producto cuenten con tecnologías innovadoras
              para el ahorro de energía y materiales que se puedan reciclar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white px-16 mb-4">
        ...
        <p>
          ...
          convertirnos en un referente, con soluciones integrales y dos unidades
          de negocio: comercializadora y fábrica.
        </p>
        <p>
          ...
          para brindarte atención oportuna. Contamos con un equipo de
        ...
        <p>
          ...
          de armar los productos, de realizar ensamble, empalme y las pruebas de
          calidad previas a la comercialización.
        </p>
        <p>
          ...
          estratégicamente; dos en el Valle de México y una en Monterrey. Desde
          ellas se realiza la distribución de luminarias por toda la República
          Mexicana, de acuerdo con tu ubicación y la de cada cliente. Nuestra
          bodega más importante se encuentra en Tlanepark; un parque industrial
          a las afueras de la Ciudad de México, con infraestructura
          especialmente creada para una ágil introducción y extracción de
          productos. Este punto es conocido como nuestro Centro de Distribución
          (CEDI), mismo que destina un piso completo al área de manufactura.
        </p>
        <p>
          ...
          Tiene la capacidad de crear hasta 30,000 configuraciones de lámparas,
          y la indumentaria correcta para pruebas de calidad, monitoreo y
          garantía.<br></br>
        ...
        <div className="flex gap-8 items-center">
          <div className="w-1/2">
            ...
            <p className="pt-6">
              ...
              través de <br></br> nuestra tienda online! Contamos con presencia
              en abarrotes y <br></br> autoservicios; sin embargo, podemos
              proveerte lámparas<br></br> personalizadas y luminarias
      ...
      <section className="bg-white px-16 pt-8 mb-32">
        ...
        <p>
          ...
          luminarias tienen garantía de 1 a 7 años! Asimismo, tenemos luminarias
          customizables que elaboramos desde cero con atención y cuidado.
        </p>
        <ul className="mb-16">
          <li>
            <p>NOM-003</p>
        ...
        <p>
          ...
          productos decorativos. Gracias a su cuerpo hecho de aluminio, un vulvo
          de LED podría iluminar tus espacios durante todo el día. Además,
          soporta variaciones de voltaje y ayuda a disipar mejor el calor.
        </p>
        <p>
